...
plt.legend(["Regular gasoline", "Premium gasoline","Diesel", "Ethanol (E85)", "Natural gas"])
...
data2.plot.bar(x='Fule type', y='Number of cars', rot=0)


# e)
plt.figure()
data3 = data.groupby('Cylinders')['CO2 Emissions (g/km)'].mean()
data3.plot.bar(x='Number of cylinders', y='CO2 emissions', rot=0)
plt.legend()
plt.show()